...
#    Updated: 2023/07/23 21:42:12 by khbouych         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = 	./main.c lexer/expand.c ./utils/util.c ./utils/util_list.c \
		...
		./parsing/parsing.c ./parsing/list_word.c ./builtins/ftecho.c ./builtins/ftexport.c ./utils/export_utils.c\
		./utils/export_utils_.c \
