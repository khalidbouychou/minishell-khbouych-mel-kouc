...
#    Updated: 2023/06/04 16:33:28 by mel-kouc         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./main.c ./utils/util.c ./utils/util_list.c  ./lexer/lexer.c ./parsing/parsing.c ./tokens/token.c  utils/ft_split.c tokens/util_token.c utils/util_.c parsing/check_syntax.c
